		...
		<div class="row check-out">
			...
			<div class="col-sm-8">
				<form action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
					...
					<table class="table table-responsive table-bordered shop_table shop_table_responsive cart" cellspacing="0">
						<thead>
						<tr>

							<th class="product-name text-center" colspan="3"><?php _e( 'Product', 'woocommerce' ); ?></th>
